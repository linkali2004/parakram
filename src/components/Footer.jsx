      ...
      <div className="footer-left">
        ...
        >
          <button
            whileHover={{ y: -5 }}
            type="button"
            className="  backdrop-blur-lg bg-[#13ADB7] font-medium rounded-lg text-sm px-3 text-center inline-flex items-center  text-[#090d06]  me-2 my-2"
          >
            <svg
        ...
        <p className="footer-links text-[#ffffff] hover:text-[#13ADB7]">
